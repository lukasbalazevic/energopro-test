...
fun RewardsScreen(
    ...
    with(viewModel) {
        EventsEffect {
            ...
            onEvent<RewardItemSelectedEvent> { event ->
...
object Rewards {
    ...
    interface Actions {
        fun onNavigateBack()
        fun onRewardItemSelected(itemId: String)
    }
    ...
    fun Content(
        ...
        Scaffold(
            ...
            Column(
                ...
                Button(onClick = { actions.onRewardItemSelected("reward1") }) {
                    Text("Reward Item 1")
                }
                Button(onClick = { actions.onRewardItemSelected("reward2") }) {
                    Text("Reward Item 2")
                }
            }
        }
...
@ScreenPreviews
@Composable
private fun RewardsContentPreview() = Showcase {
    Rewards.Content(
        actions = object : Rewards.Actions {
            override fun onNavigateBack() = Unit
            override fun onRewardItemSelected(itemId: String) = Unit
        },
    )
} 